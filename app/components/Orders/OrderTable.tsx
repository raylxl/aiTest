...
const EDITABLE_FIELDS = [
  ...
  { key: 'itemCode' as const, label: 'SKU编码', type: 'text', required: true },
  { key: 'itemName' as const, label: 'SKU名称', type: 'text', required: true },
  { key: 'quantity' as const, label: '发货数量', type: 'number', required: true },
  { key: 'specification' as const, label: '规格型号', type: 'text' },
